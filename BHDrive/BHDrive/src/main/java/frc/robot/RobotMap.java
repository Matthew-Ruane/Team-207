...
public class RobotMap {
	...
	public static final int DRIVETRAIN_RIGHT_MOTOR2_CAN_ID = 6;
	public static final int DRIVETRAIN_RIGHT_MOTOR3_CAN_ID = 8;
	
	public static final int DRIVETRAIN_LEFT_MOTOR1_CAN_ID = 3;
	public static final int DRIVETRAIN_LEFT_MOTOR2_CAN_ID = 5;
	public static final int DRIVETRAIN_LEFT_MOTOR3_CAN_ID = 71;
