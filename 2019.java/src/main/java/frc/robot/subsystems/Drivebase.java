...
public class Drivebase extends Subsystem {
  ...
  public static AHRS ahrs = new AHRS(I2C.Port.kMXP);
  public static ADXRS450_Gyro kGyro = new ADXRS450_Gyro();

  private final DefaultDriveTalonSRX mDrive_Left_Master = new DefaultDriveTalonSRX(RobotMap.mDrive_Left_A_ID);
  private final DefaultDriveTalonSRX mDrive_Left_B = new DefaultDriveTalonSRX(RobotMap.mDrive_Left_B_ID);
  private final DefaultDriveTalonSRX mDrive_Left_C = new DefaultDriveTalonSRX(RobotMap.mDrive_Left_C_ID);
  private final DefaultDriveTalonSRX mDrive_Right_Master = new DefaultDriveTalonSRX(RobotMap.mDrive_Right_A_ID);
  private final DefaultDriveTalonSRX mDrive_Right_B = new DefaultDriveTalonSRX(RobotMap.mDrive_Right_B_ID);
  private final DefaultDriveTalonSRX mDrive_Right_C = new DefaultDriveTalonSRX(RobotMap.mDrive_Right_C_ID);
